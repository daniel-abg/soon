					...
					<?php
						...
						if(isset($_GET['register'])) {
							...
							if(!$error) {
								...
								$sql_insert = "INSERT INTO users (userid, username, email, email_verified, verification_code, password, language, created) VALUES ('$userid', '$username', '$email', 'true', '$verification_code', '$password_hash', '$user_language', '$created')";
